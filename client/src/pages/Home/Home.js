      ...
      {isLogin && (
        <div className="auth">
          <div className="auth__wraper">
            ...
            <button className="auth__btn" type="submit" onClick={onLogin}>
              Sign In
            </button>
            <div className="sign">
              <p className="sign__title" onClick={handleRegister}>
      ...
      {!isLogin && (
        <div className="auth">
          <div className="auth__wraper">
            ...
            <button className="auth__btn" onClick={onRegister}>
              Register
            </button>
            <div className="sign">
              <p className="sign__title" onClick={handleLogin}>
                <FaLock className="sign__icon" />
                Log In
              </p>
            </div>
          </div>
