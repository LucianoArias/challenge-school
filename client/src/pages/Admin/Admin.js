...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    dispatch(showAllCoursesAction(token));
      ...
      <div className="dashboard__menu">
        ...
        <div className="checkbox__container">
          <div className="checkbox__wraper">
            ...
            />
            <label htmlFor="user" className="checkbox__label">
              Users Data
            </label>
          </div>
          <div className="checkbox__wraper">
            <input
              ...
              onChange={handleCheckboxChange}
            />
            <label htmlFor="course" className="checkbox__label">
              Course Data
            </label>
          </div>
        </div>
                ...
                .map((user, index) => (
                  <div index={index} className="userdata__card">
                    <div className="userdata__header">
                      ...
                      <p
                        className={
                          user.role === '' ? 'role__user' : 'role__admin'
                        }
                      >
      ...
      {isDashboardActive === 'course' && (
        <div className="category__dashboard">
            ...
            <div className="table__content">
              {isSortedBy === 'id'
                ? [...courses]
                    .sort((a, b) => a.id - b.id)
                    .filter((course) =>
                      course.title.toUpperCase().includes(searchvalue)
                    )
                    .map((course, index) => (
                      <CourseCard
                        key={index}
          ...
          <div className="add__wraper">
            <AiOutlinePlus className="add__icon" onClick={addCourse} />
          </div>
